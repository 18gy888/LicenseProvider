    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            /* //IPEndPoint（）中如果第一个参数用IPAddress.Any，我的电脑会报错，然后网上说换成本机的具体ip就可。
             IPEndPoint ip2 = new IPEndPoint(IPAddress.Parse("192.168.0.100"), 8910);
             IPEndPoint ip3 = new IPEndPoint(IPAddress.Parse("192.168.0.100"), 8888);
            ...
            clientside.SendSerialNumber(client);
            textBox1.Text = clientside.ReceiveAndSendToken(client);
            clientside.ReceiveResult(client);
